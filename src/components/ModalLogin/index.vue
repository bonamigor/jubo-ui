    ...
    <form @submit.prevent="handleSubmit">
      <label class="block">
        ...
        <input
          ...
          type="email"
          :class="{ 'border-brand-danger': !!state.email.value }"
          class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 border-transparent rounded"
          placeholder="jubo.solucoes@gmail.com">
      ...
      <label class="block mt-9">
        ...
        <input
          ...
          type="password"
          :class="{ 'border-brand-danger': !!state.password.value }"
          class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 border-transparent rounded">
      ...
      <button
        ...
        class="px-8 py-3 mt-10 text-2xl font-bold text-black rounded-full bg-blue-400 focus:outline-none transition-all duration-150">
